...
## 💰 Starting Economy — "The Marketplace Mistake"

The story starts when your driver buys a beat-up iRacing Mini Stock off Facebook Marketplace using their savings. 

You pool your money together to help them actually run it. You have a combined starting budget of **$50,000**. Sounds like a lot, but you have no equipment. 

Before you can race a single lap, you need to buy your operation to support the car sitting in the driveway:

| Item | Cost | Notes |
|---|---|---|
| 🛻 **Used Pickup Truck** | ~$15,000 | High miles, but it runs. Hauls the car and the crew. |
| 🚐 **Open Trailer** | ~$5,000 | Basic flatbed. Pray it doesn't rain. |
| 🏎️ **Car Prep & Spares** | ~$6,000 | The Marketplace car needed a new seat, belts, and a baseline setup. |
| 🔧 **Starter Tool Kit** | ~$3,000 | You'll need them. Trust us. |
| 📋 **Race Entry Fee (Race 1)** | ~$500 | Just to show up. |
| ⛽ **First Trip Fuel & Food** | ~$800 | Gas money, gas station food, energy drinks. |

**Total to get to Race 1: ~$30,300**  
**Left in the bank: ~$19,700**
